...
**hint:** All four box plots should be within the same figure. Use this [Matplotlib documentation](https://matplotlib.org/stable/gallery/statistics/boxplot_demo.html) to an for help with changing the style of the outliers.
